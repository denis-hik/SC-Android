package ru.denishik.unity.midwayApi;

import static ru.denishik.unity.midwayApi.Config.NAME_SCOOTER_BLU;
import static ru.denishik.unity.other.Utils.isServiceRunning;
...
import ru.denishik.unity.ServiceScooter;
import ru.denishik.unity.other.BluetoothConnect;
...
public class ScootersApi {
    ...
    public static void getScooters(Activity activity, getScooterCallback callback) {
        Log.d(TAG, "getScooters: onCreate");
        try {
            ArrayList<BluetoothDevice> devicesTemp = new ArrayList<>();
            blu = new BluetoothConnect(activity);
