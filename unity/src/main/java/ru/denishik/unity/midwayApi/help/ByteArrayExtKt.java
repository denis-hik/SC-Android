package ru.denishik.unity.midwayApi.help;

import static ru.denishik.unity.midwayApi.help.other.joinToString$defaultC;
import static ru.denishik.unity.midwayApi.help.other.replace$default;
...
public class ByteArrayExtKt {
    ...
    public static final byte[] writeStringBE(@NotNull byte[] bArr, @NotNull String str, int i2, @NotNull String encoding) {
        ...
        if (Intrinsics.areEqual(lowerCase, "hex")) {
            ...
            joinToString$default = ru.denishik.unity.midwayApi.help.other.joinToString$defaultC(arrayList, "", null, null, 0, null, new Function1<Integer, CharSequence>() { // from class: com.zydtech.library.ext.ByteArrayExtKt$writeStringBE$hex$2
                @NotNull
    ...
    public static final String toHexString(@NotNull byte[] bArr, final boolean z2, final boolean z3) {
        String joinToString$default;
        Intrinsics.checkNotNullParameter(bArr, "<this>");
        joinToString$default = ru.denishik.unity.midwayApi.help.other.joinToString$default(bArr, (CharSequence) "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) new Function1<Byte, CharSequence>() {
